...
import type { QueryOperationTypes as PgAdapterQueryOps } from '@prisma/orm-target-postgres/adapter/operation-types';
import type {
  Bit,
  Char,
  ...
  VarBit,
  Varchar,
} from '@prisma/orm-target-postgres/target/codec-types';
